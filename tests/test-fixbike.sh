...
process="localhost:5000/processes/fixbike/execution"
curl -X POST $process -H "Content-Type: application/json" -H "Prefer: respond-async" -d @./tests/test-fixbike.json
